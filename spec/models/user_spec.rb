  ...
  context 'ユーザー登録ができない時' do
    ...
    it 'passwordが空では登録できないこと' do
      ...
      expect(@user.errors.full_messages).to include("Password can't be blank", "Password can't be blank",
                                                    'Password is invalid. Input half-width English, Numbers, and using more than 6 characters.', "Password confirmation doesn't match Password")
    end
    ...
    it 'ユーザー本名は、名字と名前がそれぞれ必須であること(姓がない場合)' do
      ...
      expect(@user.errors.full_messages).to include("Lastname kanji can't be blank",
                                                    'Lastname kanji is invalid. Input full-width characters.')
    end
    ...
    it 'ユーザー本名は、名字と名前がそれぞれ必須であること(名がない場合)' do
      ...
      expect(@user.errors.full_messages).to include("Firstname kanji can't be blank",
                                                    'Firstname kanji is invalid. Input full-width characters.')
    end
    ...
    it 'ユーザー本名のフリガナは、名字と名前でそれぞれ必須であること（姓なし）' do
      ...
      expect(@user.errors.full_messages).to include("Lastname kana can't be blank",
                                                    'Lastname kana is invalid. Input full-width katakana characters.')
    end
    ...
    it 'ユーザー本名のフリガナは、名字と名前でそれぞれ必須であること（名なし）' do
      ...
      expect(@user.errors.full_messages).to include("Firstname kana can't be blank",
                                                    'Firstname kana is invalid. Input full-width katakana characters.')
    end
